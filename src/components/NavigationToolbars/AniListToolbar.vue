  ...
  <v-toolbar-items>
    <v-tooltip bottom>
      <template v-slot:activator="{ on: toolTip }">
        <v-btn text exact :to="{ name: 'Home' }" v-on="{ ...toolTip }"><v-icon>mdi-home</v-icon></v-btn>
      </template>
    ...
    <template v-if="isAuthenticated">
      <v-tooltip bottom>
        <template v-slot:activator="{ on: toolTip }">
          <v-btn text exact :to="{ name: 'Watching' }" v-on="{ ...toolTip }"><v-icon color="green">mdi-play</v-icon> ({{ watchingAmount }})</v-btn>
        </template>
      ...
      <v-tooltip bottom>
        <template v-slot:activator="{ on: toolTip }">
          <v-btn text exact :to="{ name: 'Repeating' }" v-on="{ ...toolTip }"><v-icon color="green darken-3">mdi-repeat</v-icon> ({{ repeatingAmount }})</v-btn>
        </template>
      ...
      <v-tooltip bottom>
        <template v-slot:activator="{ on: toolTip }">
          <v-btn text exact :to="{ name: 'Completed' }" v-on="{ ...toolTip }"><v-icon color="blue">mdi-check</v-icon> ({{ completedAmount }})</v-btn>
        </template>
      ...
      <v-tooltip bottom>
        <template v-slot:activator="{ on: toolTip }">
          <v-btn text exact :to="{ name: 'Paused' }" v-on="{ ...toolTip }"><v-icon color="yellow darken-2">mdi-pause</v-icon> ({{ pausedAmount }})</v-btn>
        </template>
      ...
      <v-tooltip bottom>
        <template v-slot:activator="{ on: toolTip }">
          <v-btn text exact :to="{ name: 'Dropped' }" v-on="{ ...toolTip }"><v-icon color="red darken-1">mdi-stop</v-icon> ({{ droppedAmount }})</v-btn>
        </template>
      ...
      <v-tooltip bottom>
        <template v-slot:activator="{ on: toolTip }">
          <v-btn text exact :to="{ name: 'Planning' }" v-on="{ ...toolTip }"><v-icon>mdi-playlist-plus</v-icon> ({{ planningAmount }})</v-btn>
        </template>
